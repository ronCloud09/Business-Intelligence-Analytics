                            ...
                            <tbody>
                                @forelse($topProducts as $index => $product)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="{{ $change >= 0 ? 'change-up' : 'change-down' }}" data-tip="{{ number_format($product['prev_units']) }} units last month → {{ number_format($product['units_sold']) }} units this month">
                                                {{ $change >= 0 ? '↑' : '↓' }} {{ abs($change) }}%
                                            </span>
                                        </td>
                                        <td>
                                            <div class="coverage-cell" data-tip="{{ $stockDays }} days of stock remaining">
                                                ...
                                                <div class="coverage-bar"><div class="coverage-fill {{ $coverageClass }}" style="width: {{ $product['coverage'] }}%;"></div></div>
                                            </div>
                                        </td>
