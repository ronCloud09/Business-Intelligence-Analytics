        ...
        <div class="content-container">
            ...
            <div class="dashboard-layout-grid">
                <div class="section-column">
                    ...
                    <div class="ui-card" style="flex: none;">
                        ...
                        <div class="forecast-sub-row">
                            ...
                            <div class="sub-box">
                                <div class="sub-box-label"><i data-lucide="package" class="sub-icon"></i>High Demand Products
                                </div>
                ...
                <div class="section-column">
                    ...
                    <div class="ui-card operational-efficiency-card" style="flex: none;">
                        <div class="card-header">
                    ...
                    <div class="ui-card alert-feed-card" style="display:flex; flex-direction:column; gap:0.75rem;">
