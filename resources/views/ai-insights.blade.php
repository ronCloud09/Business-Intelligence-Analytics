    ...
    <div class="content-container">
        ...
        <div class="ai-insights-grid">
            ...
            <div class="insight-card">
                <h3>Executive Summary <span class="info-dot" data-tooltip="AI-generated overview of the most critical business metrics and performance indicators across all modules.">i</span></h3>
                <div class="card-subtitle">{{ empty($executiveSummary) ? 'No data available' : 'AI-powered analysis' }}</div>
                <div class="insight-list">
                    ...
                    <div class="insight-item">
                        <div class="insight-text-wrapper">
                            <p style="color: var(--slate-500);">AI insights will appear here once connected to data sources.</p>
                        </div>
                    </div>
                    @endforelse
                </div>
            ...
            {{-- Top Recommendations --}}
            <div class="insight-card">
                <h3>Top Recommendations <span class="info-dot" data-tooltip="Prioritized actionable recommendations generated by the AI engine.">i</span></h3>
                ...
                <div class="insight-list">
                    ...
                    <div class="insight-item">
                        <div class="insight-text-wrapper">
                            <p style="color: var(--slate-500);">Recommendations will be generated once AI is connected to data sources.</p>
                        </div>
                    </div>
                    @endforelse
                </div>
            ...
            {{-- Risk Detection --}}
            <div class="insight-card">
                <h3>Risk Detection <span class="info-dot" data-tooltip="Automated risk monitoring across supply chain, operations, and financial domains.">i</span></h3>
                <div class="card-subtitle">&nbsp;</div>
                <div class="insight-list">
                    ...
                    <div class="insight-item">
                        <div class="insight-text-wrapper">
                            <p style="color: var(--slate-500);">Risk assessment will appear once AI is connected to data sources.</p>
                        </div>
                    </div>
                    @endforelse
                </div>
